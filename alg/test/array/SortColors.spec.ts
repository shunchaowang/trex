...
describe("test sort colors", () => {
  ...
  test(`${case1} becomes ${expected1} after sorting`, () => {
    sortColors(case1)
  ...
  test(`${case2} becomes ${expected2} after sorting`, () => {
    sortColors(case2)
  ...
  test(`${case3} becomes ${expected3} after sorting`, () => {
    sortColors(case3)
    expect(case3).toEqual(expected3)
  })
  const case4 = [2, 2, 0]
  const expected4 = [0, 2, 2]
  test(`${case4} becomes ${expected4} after sorting`, () => {
    sortColors(case4)
